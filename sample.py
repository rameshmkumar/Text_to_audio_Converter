...
# Your complete front-end HTML as a template string:
HTML_CONTENT = """
<!DOCTYPE html>
<html lang="en">
<head>
...
<section id="home">
    ...
    <p class="note">Note: Free version allows a maximum of 350 characters. Please contact us for unlimited characters and ads free experience.</p>

    <label for="language-select">Select Language/Voice:</label>
...
<script>
    ...
    textInput.addEventListener('input', function() {
        ...
        if (textLength > 1000) {
            this.value = this.value.substring(0, 1000); // Trim the text to 350 chars
